                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {cities.map((city, idx) => (
                                            <tr key={city._id} className={`hover:bg-gray-50`}>
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900">{city.email}</div>
                                                </td>
                                                <td className="px-4 py-4 whitespace-nowrap">
                                                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${roleBadgeClass(city.role)}`}>
                                                        {city.role}
                                                    </span>
                                                </td>
                                            </tr>
                                            ...
                                            <li key={city._id} className="border rounded-lg p-3">
                                                <div className="flex justify-between items-start gap-2">
                                                    <div>
                                                        ...
                                                        <div className="text-xs text-gray-500">{city.email}</div>
                                                    </div>
                                                    <div>
                                                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${roleBadgeClass(city.role)}`}>
                                                            {city.role}
